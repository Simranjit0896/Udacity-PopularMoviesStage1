...
public class MainActivity extends AppCompatActivity {
    ...
    private void getMoviesFromTMDB(String sortMethod) {
        if (networkAvailable()) {
            ...
            // Execute task
            FetchMovies movieTask = new FetchMovies(taskCompleted, apiKey);
    ...
    private String getSortMethod(String sort) {
